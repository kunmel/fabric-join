...
func (s *mspMessageCryptoService) VerifyBlock(chainID common.ChainID, seqNum uint64, signedBlock []byte) error {
	fmt.Println("peer/gossip/mcs.go VerifyBlock() 开始")
	...
	fmt.Println("peer/gossip/mcs.go VerifyBlock() 标记1")
	if block.Header == nil {
		return fmt.Errorf("Invalid Block on channel [%s]. Header must be different from nil.", chainID)
	}
	fmt.Println("peer/gossip/mcs.go VerifyBlock() 标记2")
	...
	fmt.Println("peer/gossip/mcs.go VerifyBlock() 标记3")
	...
	fmt.Println("peer/gossip/mcs.go VerifyBlock() 标记7")
	...
	fmt.Println("peer/gossip/mcs.go VerifyBlock() 标记8")
	...
	fmt.Println("peer/gossip/mcs.go VerifyBlock() 标记9")
	...
	fmt.Println("peer/gossip/mcs.go VerifyBlock() 标记10")
	// - Evaluate policy
