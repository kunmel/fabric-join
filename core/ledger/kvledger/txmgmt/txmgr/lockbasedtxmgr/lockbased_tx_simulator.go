...
func newLockBasedTxSimulator(txmgr *LockBasedTxMgr, txid string) (*lockBasedTxSimulator, error) {
	...
	return &lockBasedTxSimulator{lockBasedQueryExecutor{helper, txid}, rwsetBuilder, false, false, false, false}, nil  //NEW update
}
//NEW add
func (s *lockBasedTxSimulator) SetCrossLocked(b bool){
	s.CrossLocked = b
}
//NEW add
func (s *lockBasedTxSimulator) GetCrossLocked() bool{
	return s.CrossLocked
}
