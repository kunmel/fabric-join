...
//
// NEW add
func (h *DBHandle) GetConstructLevelKey(key []byte) []byte{
	return constructLevelKey(h.dbName, key)
}
...
func (h *DBHandle) WriteBatch(batch *UpdateBatch, sync bool) error {
	...
	for k, v := range batch.KVs {
		...
		fmt.Println("这里 common/ledger/util/leveldbhelper/leveldb_provider.go WriteBatch()")
